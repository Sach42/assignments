...
public class UserController {
    ...
    public String add(@ModelAttribute("user") @Valid final UserDTO userDTO,
        ...
        if (!bindingResult.hasFieldErrors("userEmail") && userService.userEmailExists(userDTO.getUserEmail())) {
            bindingResult.rejectValue("userEmail", "Exists.user.userEmail");
        }
    ...
    public String edit(@PathVariable final Long id,
        ...
        if (!bindingResult.hasFieldErrors("userEmail") &&
                !userDTO.getUserEmail().equalsIgnoreCase(currentUserDTO.getUserEmail()) &&
                userService.userEmailExists(userDTO.getUserEmail())) {
            bindingResult.rejectValue("userEmail", "Exists.user.userEmail");
        }
        if (bindingResult.hasErrors()) {
            return "user/edit";
